...
namespace EmployeeManagementSystem
{
    public partial class AddEmployee : UserControl
    {
                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\gokgo\source\repos\EmployeeManagementSystem\EmployeeManagementSystem\Directory\" +
        ...
        private void addEmployee_updateBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult check = MessageBox.Show(" Are you sure you want to UPDATE " + " Employee ID: " + addEmployee_fullName.Text.Trim() +
        ...
        private void addEmployee_deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult check = MessageBox.Show(" Are you sure you want to DELETE " + " Employee ID: " + addEmployee_fullName.Text.Trim() +
                    "?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                if (check == DialogResult.Yes)
                {
                    try
